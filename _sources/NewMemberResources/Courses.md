...
| EME 523 | Stochastic Optimization Methods of Energy and Environmental Systems | Offered in spring. **Instructor may inflate difficulty of course on syllabus to make class size smaller.** Seminar style. Covers the basics of linear and dynamic programming, then moves into stochastic processes, Monte Carlo methods, and Reinforcement Learning. |
